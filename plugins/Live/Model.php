...
class Model
{
    ...
    public function makeLogVisitsQueryStringNoVisitorLog($idSite, $startDate, $endDate, $segment, $offset, $limit, $visitorId, $minTimestamp, $filterSortOrder)
    {
        ...
        $select = "idvisit,
            ...
            '' AS config_browser_engine,
            '' AS config_browser_name,
            '' AS config_browser_version,
            '' AS config_client_type,
            '' AS config_device_brand,
            '' AS config_device_model,
            '' AS config_device_type,
            '' AS config_os,
            '' AS config_os_version,
            visit_total_events,
            visitor_localtime,
